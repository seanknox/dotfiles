...
prompt_kubectl()
{
  ...
  # Get current context
  local kubectl_context=$(kubectl config view -o jsonpath='{.current-context}')
  if [[ -n $kubectl_context ]]; then
    ...
    local kubectl_context=$(echo $kubectl_context | sed 's/\"//g')
    prompt_segment 111 black "\U2388  $kubectl_context"
  fi
}
